# Block 1: Project-based workflows {.unnumbered}
...
#| echo: false
#| out-width: "80%"
#| fig-cap: "A typical R project layout"
...
convention we follow all day (we will come back to this on Day 2!):
...
penguins_raw <- readr::read_csv(here("data", "raw", "penguins_raw.csv"))
```
