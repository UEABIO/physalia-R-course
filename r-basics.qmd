...
**Question 7.** A vector must always contain elements of the same data type (e.g logical, character, numeric) `r torf(TRUE)`.

**Question 8.** A dataframe/tibble must always contain elements of the same data `r torf(FALSE)`
