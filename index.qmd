...
knitr::write_bib(c(
  .packages(),
  # Core
  'tidyverse', 'palmerpenguins', 'here', 'janitor', 'fs',
  # Data Wrangling & Import
  'data.table', 'dtplyr', 'dbplyr', 'arrow', 'duckdb', 'rvest', 'assertr', 'tidylog',
  # Data Exploration
  'skimr', 'naniar',
  # Statistical Modelling
  'broom', 'broom.mixed', 'lme4', 'lmerTest', 'emmeans', 'glmnet', 'caret', 'randomForest', 'rpart', 'xgboost',
  # Testing & Benchmarking
  'testthat', 'bench',
  # Tables
  'gt', 'gtExtras', 'kableExtra',
  # ggplot Extensions
  'patchwork', 'scales', 'colorBlindness', 'colorspace', 'ggdist', 'ggrepel', 'ggtext', 'ggview',
  'ggbeeswarm', 'gghighlight', 'ggh4x', 'ggpubr', 'ggdensity', 'ggbump', 'ggalt', 'ggridges',
  'ggforce', 'geomtextpath', 'ragg', 'png', 'showtext', 'RColorBrewer', 'gapminder',
  # Maps & Spatial
  'sf', 'rnaturalearth',
  # Reproducible Reports
  'knitr', 'quarto',
  ...
  'plotly', 'shiny',
  # Github
  'gitcreds', 'usethis', 'renv',
  # AI & Other Tools
  'tidychatmodels', 'webexercises', 'downloadthis', 'waldo'
