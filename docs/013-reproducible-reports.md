...
**Question.** If we wanted to see the R code, but **not** its output we need to select what combo of code chunk options? <select class='webex-select'><option value='blank'></option><option value=''>echo = FALSE, eval = TRUE</option><option value='answer'>echo = TRUE, eval = FALSE</option><option value=''>echo = TRUE, eval = TRUE</option><option value=''>echo = FALSE, eval = FALSE</option></select>
...
This book was printed on 2026-05-21
...
```
````
<img src="013-reproducible-reports_files/figure-html/unnamed-chunk-11-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="013-reproducible-reports_files/figure-html/unnamed-chunk-12-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="013-reproducible-reports_files/figure-html/unnamed-chunk-13-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="013-reproducible-reports_files/figure-html/unnamed-chunk-14-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="013-reproducible-reports_files/figure-html/unnamed-chunk-15-1.png" width="50%" style="display: block; margin: auto;" />
...
```{=html}
<div id="adxjifrrid" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#adxjifrrid table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#adxjifrrid thead, #adxjifrrid tbody, #adxjifrrid tfoot, #adxjifrrid tr, #adxjifrrid td, #adxjifrrid th {
  border-style: none;
}
...
#adxjifrrid .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#adxjifrrid .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#adxjifrrid .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#adxjifrrid .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#adxjifrrid .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#adxjifrrid .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#adxjifrrid .gt_spanner_row {
  border-bottom-style: hidden;
}

#adxjifrrid .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#adxjifrrid .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#adxjifrrid .gt_from_md > :first-child {
  margin-top: 0;
}

#adxjifrrid .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#adxjifrrid .gt_row_group_first td {
  border-top-width: 2px;
}

#adxjifrrid .gt_row_group_first th {
  border-top-width: 2px;
}

#adxjifrrid .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#adxjifrrid .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#adxjifrrid .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#adxjifrrid .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#adxjifrrid .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#adxjifrrid .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#adxjifrrid .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#adxjifrrid .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#adxjifrrid .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#adxjifrrid .gt_font_normal {
  font-weight: normal;
}

#adxjifrrid .gt_font_bold {
  font-weight: bold;
}

#adxjifrrid .gt_font_italic {
  font-style: italic;
}
...
#adxjifrrid .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#adxjifrrid .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#adxjifrrid .gt_indent_1 {
  text-indent: 5px;
}

#adxjifrrid .gt_indent_2 {
  text-indent: 10px;
}

#adxjifrrid .gt_indent_3 {
  text-indent: 15px;
}

#adxjifrrid .gt_indent_4 {
  text-indent: 20px;
}

#adxjifrrid .gt_indent_5 {
  text-indent: 25px;
}
</style>
