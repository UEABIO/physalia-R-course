# (PART\*) Data visualisation workshop {.unnumbered}
...
This workshop is a half-day, hands-on introduction to data visualisation in R with `ggplot2`. It is built around two ideas: 
...
<div class="note">
<p><strong>Facilitator to add:</strong> a single paragraph introducing
yourself, the institutional context, the housekeeping (toilets, fire
alarms, breaks), and a short statement of <em>why</em> this workshop
exists in your programme. This sets the tone for the participatory
segments later.</p>
</div>


# Block 1: Foundations and graph crimes

## How we see data

Our visual system did not evolve to read graphs. Some visual features are detected before conscious attention engages: a red dot among grey dots, a single triangle in a sea of circles, an unusually large shape in a field of small ones. This is called **pre-attentive processing** (Healey and Enns, 2012). When designing figures, encoding important information as features the eye picks up automatically directs attention without effortful search. Encoding the same information as a subtle change in line style or a slightly different shade requires the reader to look for it.

<div class="note">
<p><strong>Facilitator to add:</strong> the <em>find the different size
object</em> image and the <em>which one is biggest</em> preview
exercises from the existing slide deck
(<code>images/find_size.png</code> and the four-panel sizes graphic).
Run them as participatory show-of-hands moments, as the existing 2-hour
workshop already does.</p>
</div>
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-5-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-6-1.png" width="100%" style="display: block; margin: auto;" />
...
<div class="note">
<p><strong>Facilitator to add:</strong> the five graph-crime example
images from the existing slide deck
(<code>images/no_baseline.png</code>,
<code>images/manipulating_y.png</code>,
<code>images/cherry_picking.png</code>,
<code>images/wrong_graph.png</code>, <code>images/convention.png</code>,
and the bonus <code>images/correlation_xkcd.png</code> and
<code>images/bad_correlation.png</code>). Each one anchors the
discussion below to a concrete case.</p>
</div>
...
<div class="task">
<p>In pairs you will be given two figures. For each one:</p>
...
<p>You have five minutes. Each pair will report on one of their figures
to the room (one minute per figure).</p>
</div>

<div class="note">
<p><strong>Facilitator to add:</strong> the figure packets (typically
two figures per pair, printed). Use the existing graph-crimes resource
from the 2-hour workshop, or curate eight figures from published papers
in the participants’ field. Print on A4, one figure per page. After the
reporting back, name the principle each crime violates so that
participants begin to connect crime → principle → fix.</p>
</div>


# Block 2: Choosing the right figure
...
<div class="task">
<p>In groups of three or four, you have one finding:</p>
<blockquote>
<p><strong>Gentoo penguins are substantially heavier than Adelie and
Chinstrap penguins</strong> (mean 5076g vs 3701g and 3733g respectively;
n = 124, 151, 68).</p>
</blockquote>
<p>Each group is assigned one context:</p>
<ol style="list-style-type: decimal">
...
<p>On the paper provided, sketch your figure. You must make explicit
decisions about: figure type, title (descriptive or explanatory), legend
or direct labels, statistical annotations, and what you include or omit.
You have eight minutes.</p>
</div>

<div class="note">
<p><strong>Facilitator to add:</strong> A3 paper and markers; the four
context cards (one per group). After the sketches are produced, lead a
five-minute gallery walk: where did the journal group and the museum
group diverge most? Did anyone use direct labelling? Did anyone use
highlighting? Which group simplified most, and did they lose anything
important in doing so?</p>
</div>


# Block 3: Themes and scales
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-15-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-17-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-20-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-21-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-22-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-26-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-30-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-34-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-35-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="check_data-visualisation-workshop_files/figure-html/unnamed-chunk-39-1.png" width="100%" style="display: block; margin: auto;" />
...
# Block 5: Saving figures correctly
...
single paragraph.</p>
<p>When you have finished, swap with the person next to you and
check:</p>
<ul>
...
<div class="note">
<p><strong>Facilitator to add:</strong> take two or three volunteer
legends and critique them in front of the room. Common failures:
omitting sample sizes; treating “n = 343” as sufficient when per-group
sample sizes are needed; not defining all visual layers (the cloud and
the jittered points are the two most commonly forgotten); writing in
present tense rather than past tense; treating the legend as a caption
(“Figure 1. Penguins.”) rather than a self-contained description;
including a result claim in the descriptive sentence.</p>
</div>
...
<div class="note">
<p><strong>Facilitator to add:</strong> brief closing remarks (≤2
minutes). Acknowledge that this is only one half-day, that the
participants’ figures will not be transformed overnight, and that the
value comes from applying the principles to one or two figures per
project rather than to all figures at once. Direct participants to
Wilke’s <em>Fundamentals of Data Visualization</em>
(https://clauswilke.com/dataviz/) for the canonical further reading.
Then introduce the take-home exercise below.</p>
</div>
...
| When | What |
|---|---|
| Day 1–3 | Build the figure: chart type, palette, theme, scales, extensions |
| Day 4 | Verify with `cvdPlot()`; save in both formats; write the legend |
| Day 5 | Ask a colleague to review the figure and the legend; revise |
| Follow-up session | Bring your figure and legend for group critique |

<div class="note">
<p><strong>Facilitator to specify:</strong> how the take-home figures
are to be submitted (a shared folder, an email, a pull request to a
teaching repository), when the follow-up session will take place, and
what the format of the group critique will be. Without a concrete
submission process and a deadline, the take-home exercise will not be
completed by most participants.</p>
</div>
