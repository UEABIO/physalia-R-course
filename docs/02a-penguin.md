...
<div class='webex-radiogroup' id='radio_FGDCCOOZMO'><label><input type="radio" autocomplete="off" name="radio_FGDCCOOZMO" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_FGDCCOOZMO" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_FGDCCOOZMO" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_FGDCCOOZMO" value="answer"></input> <span>dmy()</span></label></div>
