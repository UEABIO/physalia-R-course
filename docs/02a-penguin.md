...
<div class='webex-radiogroup' id='radio_FDXYKWBMUD'><label><input type="radio" autocomplete="off" name="radio_FDXYKWBMUD" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_FDXYKWBMUD" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_FDXYKWBMUD" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_FDXYKWBMUD" value="answer"></input> <span>dmy()</span></label></div>
