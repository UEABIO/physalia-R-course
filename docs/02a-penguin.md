...
<div class='webex-radiogroup' id='radio_GGPJIARIGG'><label><input type="radio" autocomplete="off" name="radio_GGPJIARIGG" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_GGPJIARIGG" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_GGPJIARIGG" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_GGPJIARIGG" value="answer"></input> <span>dmy()</span></label></div>
