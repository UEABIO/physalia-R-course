...
<div class='webex-radiogroup' id='radio_JCNYSKYIIW'><label><input type="radio" autocomplete="off" name="radio_JCNYSKYIIW" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_JCNYSKYIIW" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_JCNYSKYIIW" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_JCNYSKYIIW" value="answer"></input> <span>dmy()</span></label></div>
