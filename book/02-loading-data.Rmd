...
```{r, eval=TRUE, echo=FALSE, out.width="80%", fig.cap = ""}
knitr::include_graphics("images/rainbow_options.png")
```

```{r, eval=TRUE, echo=FALSE, out.width="80%", fig.cap = ""}
knitr::include_graphics("images/rainbows.png")
```
...
```{r, eval=TRUE, echo=FALSE, out.width="80%", fig.cap = ""}
knitr::include_graphics("images/background_jobs.png")
```
...
```{r, eval=TRUE, echo=FALSE, out.width="80%", fig.cap = ""}
knitr::include_graphics("images/snippet.png")
```
