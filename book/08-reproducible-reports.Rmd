...
This report provides an analysis of the Palmer Penguins dataset. The current report focuses on the `` r "\u0060params$species\u0060"` `` species from `` `r "\u0060r params$island\u0060"` `` island.
...
3. **Dynamic Text**: The inline R code (e.g.,`` `r "\u0060r params$species\u0060"` ``) dynamically updates the text in the report to reflect the chosen parameters.
