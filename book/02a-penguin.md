...
<div class='webex-radiogroup' id='radio_HHVHQQTSIH'><label><input type="radio" autocomplete="off" name="radio_HHVHQQTSIH" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_HHVHQQTSIH" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_HHVHQQTSIH" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_HHVHQQTSIH" value="answer"></input> <span>dmy()</span></label></div>
