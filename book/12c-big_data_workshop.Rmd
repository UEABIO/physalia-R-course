...
```{r compression-comparison, eval = FALSE}
tibble(
...
```{r appendix-dt-examples, eval = FALSE}
...
```{r appendix-dt-verify, eval = FALSE}
lazy_dt(surveys_dt) |>
